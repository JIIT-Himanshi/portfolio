  ...
  return (
    <footer className="py-14 px-6">
      <div className="max-w-7xl mx-auto">
        <div className="glass-card rounded-[2rem] p-8 border border-light-border/30 dark:border-dark-border/40">
        ...
        {/* Bottom decoration */}
          <div className="mt-8 pt-8 border-t border-light-border/30 dark:border-dark-border/40">
            <p className="text-center text-xs text-light-text-secondary/70 dark:text-dark-text-secondary/70">
              Built with React, Tailwind CSS, GSAP & Framer Motion • Crafted with ❤️ by Himanshi
            </p>
          </div>
        </div>
      </div>
